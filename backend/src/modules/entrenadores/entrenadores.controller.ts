...
export class EntrenadoresController {
  ...
  @ApiOperation({
    summary: 'Asignar entrenador a socio',
    description: 'Crea la relación entrenador ↔ socio.',
  })
  ...
  @Roles('admin')
  @ApiOperation({
    summary: 'Asignación masiva de entrenador a múltiples socios (HU-08)',
  })
  @ApiResponse({ status: 201, description: 'Asignaciones creadas' })
  asignacionMasiva(@Body() dto: BulkAsignacionDto) {
    return this.entrenadoresService.asignarMasivo(dto);
  }
